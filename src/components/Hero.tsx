      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
            ...
            <span className="text-indigo-600 block">Using 80% Fewer Tokens</span>
          </h1>
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Button onClick={scrollToApp} size="lg" className="bg-indigo-600 hover:bg-indigo-700">
          ...
          <div className="mt-16 flex items-center justify-center gap-x-8 text-sm font-semibold text-gray-900">
