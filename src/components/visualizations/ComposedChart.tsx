...
import { Line, Bar, ComposedChart as RechartsComposedChart, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, Brush } from 'recharts'
...
export function ComposedChart({ data, dataPoints, xAxisLabel, yAxisLabel }: ComposedChartProps) {
  const domain = getPaddedDomain(data, dataPoints.yAxis)
  return (
    <ResponsiveContainer width="100%" height="100%">
      <RechartsComposedChart data={data} margin={{ left: 40, right: 20, top: 20, bottom: 20 }}>
